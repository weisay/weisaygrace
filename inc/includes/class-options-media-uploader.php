...
class Options_Framework_Media_Uploader {
	...
	static function optionsframework_uploader( $_id, $_value, $_desc = '', $_name = '' ) {
		...
		$output .= '<input id="' . $id . '" class="upload' . $class . '" type="text" name="'.$name.'" value="' . $value . '" placeholder="' . __('请选择文件', 'theme-textdomain') .'" />' . "\n";
		if ( function_exists( 'wp_enqueue_media' ) ) {
			...
			$output .= '<p><i>' . __( '升级您的WordPress版本以获得完整媒体支持。', 'theme-textdomain' ) . '</i></p>';
		}
